...
document.getElementById("foto").src="./images/vera.jpg";
document.getElementById("elnombre").innerHTML="Josue Vera"; 
 ...
 document.getElementById("blog-relacionados").innerHTML="<p><b>Temas relacionados:</b></p><hr> <p><a href='https://congresoutlvte.org/QuinonezBryan'>Quinonez Bryan</a></p><p><a href='eys-damaris.php'>Damaris Viallalva</a></p> ";
